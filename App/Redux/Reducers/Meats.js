...
export const MeatReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.EDIT_MEATS_REQUEST:
      return {
        ...state,
        meatSpinner: true
      };
    case actionTypes.EDIT_MEATS_SUCCESS:
      return {
        ...state,
        editMeatResponse: action.payload,
        meatSpinner: false
      };
    case actionTypes.EDIT_MEATS_FAILURE:
      return {
        ...state,
        error: action.error,
        meatSpinner: false
    ...
    case 'RESET_DATA_EDIT_MEAT_RESPONSE':
      return {
        ...state,
        editMeatResponse: [],
      };
